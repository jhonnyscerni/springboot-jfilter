package br.com.siberius.jfilter.sql.oracle;
...
public class OracleWhereStep implements SqlWhereStep {

	private JdbcTemplate jdbcTemplate;

	private Map<String, String> sqlFragments = new HashMap<>();

	public OracleWhereStep(JdbcTemplate jdbcTemplate, Map<String, String> sqlFragments) {
		super();
	...
	public SqlOrderByStep where(Filterable filter) {
		...
		return new OracleOrderByStep(jdbcTemplate, sqlFragments);
	}
