...
public class OracleContextImpl implements SqlContext {

	private JdbcTemplate jdbcTemplate;

	private Map<String, String> sqlFragments = new HashMap<>();

	public OracleContextImpl(JdbcTemplate jdbcTemplate) {
		super();
	...
	public SqlWhereStep selectFrom(String sql) {
		...
		return new OracleWhereStep(jdbcTemplate, sqlFragments);
	}
