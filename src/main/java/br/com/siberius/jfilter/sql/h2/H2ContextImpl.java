package br.com.siberius.jfilter.sql.h2;
...
public class H2ContextImpl implements SqlContext {

	private JdbcTemplate jdbcTemplate;

	private Map<String, String> sqlFragments = new HashMap<>();

	public H2ContextImpl(JdbcTemplate jdbcTemplate) {
		super();
	...
	public SqlWhereStep selectFrom(String sql) {
		...
		return new H2WhereStep(jdbcTemplate, sqlFragments);
	}
